...
import {
  StyledCopyButton,
  StyledPrimaryButton,
  StyledRadioButton, StyledSecondaryButton,
  StyledToolBody,
  StyledToolBodyTitle,
  StyledToolContainer,
...
class ExtraSpaceRemover extends Component {
  state = {
    input: '',
    result: '',
    copied: false,
    ...
    return (
      <StyledToolBody>
        <StyledForm>
          ...
          <StyledRadioGroup>
            <StyledRadioButton
              label={strings.tools.strings.extraSpaceRemover.removeIncludeLineBreaks}
              name='radioGroup'
              value='include'
            ...
            />
            <StyledRadioButton
              label={strings.tools.strings.extraSpaceRemover.removeExcludeLineBreaks}
              name='radioGroup'
              value='exclude'
  ...
  render() {
    return (
      <StyledToolContainer>
        <StyledToolName>{strings.menu.strings.extraSpaceRemover}</StyledToolName>
...
export default ExtraSpaceRemover;